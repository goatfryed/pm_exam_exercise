...
import de.goatfryed.pm.foxAndGeese.model.tables.GameTable;
...
public class GameController {
    ...
    private boolean checkGeeseWon() {
        ...
        try {
            ...
            throw new NullPointerException("there must be a fox in a game of fox and geese");
        }
