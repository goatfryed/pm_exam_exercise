...
public class PlayerTable 
{
   ...
   public GameTable expandFoxOf(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Player start = (Player) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getFoxOf());
         this.table.add(newRow);
      }
      return result;
   }

   public PlayerTable hasFoxOf(GameTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public GameTable expandGeeseOf(String... rowName)
   {
      GameTable result = new GameTable();
      result.setColumnMap(this.columnMap);
      result.setTable(table);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Player start = (Player) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getGeeseOf());
         this.table.add(newRow);
      }
      return result;
   }

   public PlayerTable hasGeeseOf(GameTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public GameTable expandCurrentPlayerOf(String... rowName)
   {
      GameTable result = new GameTable();
      result.setColumnMap(this.columnMap);
      result.setTable(table);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Player start = (Player) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getCurrentPlayerOf());
         this.table.add(newRow);
      }
      return result;
   }

   public PlayerTable hasCurrentPlayerOf(GameTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         Player start = (Player) row.get(columnMap.get(this.getColumnName()));
         Game other = (Game) row.get(columnMap.get(rowName.getColumnName()));
         if (start.getCurrentPlayerOf() == other)
         {
            this.table.add(row);
         }
      }
   ...
   public GameTable expandWinnerOf(String... rowName)
   {
      GameTable result = new GameTable();
      result.setColumnMap(this.columnMap);
      result.setTable(table);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Player start = (Player) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getWinnerOf());
         this.table.add(newRow);
      }
      return result;
   }

   public PlayerTable hasWinnerOf(GameTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public MeepleTable expandMeeples(String... rowName)
   {
      ...
      {
         Player start = (Player) row.get(columnMap.get(this.getColumnName()));
         for (Meeple current : start.getMeeples())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public PlayerTable hasMeeples(MeepleTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getMeeples().contains(other))
         {
            this.table.add(row);
         }
      }
