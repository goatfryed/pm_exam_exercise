...
public class BoatTable  
{
   ...
   public BoatTable(Boat... start)
   {
      this.setColumnName("Boat");
      columnMap.put(this.getColumnName(), 0);
      for (Boat current : start)
      {
   ...
   public BoatTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public BoatTable setColumnName(String value)
   {
   ...
   public BoatTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandType(String... rowName)
   {
      ...
      {
         Boat start = (Boat) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getType());
   ...
   public BoatTable hasPlayer(PlayerTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public BoatTable hasSections(SectionTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public BoatTable selectColumns(String... columnNames)
   {
   ...
   public BoatTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public BoatTable filter(Predicate< Boat > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public BoatTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Boat > toSet()
   {
      LinkedHashSet< Boat > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Boat value = (Boat) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
