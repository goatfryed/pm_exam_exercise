...
public class SectionTable  
{
   ...
   public SectionTable(Section... start)
   {
      this.setColumnName("Section");
      columnMap.put(this.getColumnName(), 0);
      for (Section current : start)
      {
   ...
   public SectionTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public SectionTable setColumnName(String value)
   {
   ...
   public SectionTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public intTable expandColumn(String... rowName)
   {
      ...
      {
         Section start = (Section) row.get(columnMap.get(this.getColumnName()));
   ...
   public BoatTable expandBoat(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Section start = (Section) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getBoat());
         this.table.add(newRow);
      }
      return result;
   }

   public SectionTable hasBoat(BoatTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ShotTable expandShotBy(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Section start = (Section) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getShotBy());
         this.table.add(newRow);
      }
      return result;
   }

   public SectionTable hasShotBy(ShotTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public SectionTable selectColumns(String... columnNames)
   {
   ...
   public SectionTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public SectionTable filter(Predicate< Section > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public SectionTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Section > toSet()
   {
      LinkedHashSet< Section > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Section value = (Section) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
   ...
   public SectionTable hasPlayer(PlayerTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
